        ...
        <div class="col-md-6">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control agenform bg-light" name="firstname">
                </div>
                <div class="form-group">
                    <label>Surname</label>
                    <input type="text" class="form-control agenform bg-light" name="surname">
                </div>
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control agenform bg-light" name="email">
                </div>
                <div class="form-group">
                    <label>Contact No.</label>
                    <input type="text" class="form-control agenform bg-light" name="contact">
                </div>
                <div class="form-group">
                    <label>Address</label>
                    <input type="text" class="form-control agenform bg-light" name="surname">
